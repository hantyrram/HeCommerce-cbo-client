...
export default function UserAccountCreate(props){
   ...
   const generateCredential = useApiRequest('EMPLOYEE$USERACCOUNT$CREDENTIAL_GENERATE',dispatch);   
   const createUserAccountCredential = useApiRequest('EMPLOYEE$USERACCOUNT$CREDENTIAL_CREATE',dispatch);
